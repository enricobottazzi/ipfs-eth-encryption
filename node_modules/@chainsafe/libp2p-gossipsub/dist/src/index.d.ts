...
import { MessageAcceptance, MsgIdFn, TopicStr, MsgIdStr, PeerIdStr, FastMsgIdFn, AddrInfo, DataTransform, TopicValidatorFn, MsgIdToStrFn } from './types.js';
import type { GossipsubOptsSpec } from './config.js';
import { Components, Initializable } from '@libp2p/interfaces/components';
import { Message, PublishResult, PubSub, PubSubEvents, PubSubInit, StrictNoSign, StrictSign } from '@libp2p/interfaces/pubsub';
...
export declare class GossipSub extends EventEmitter<GossipsubEvents> implements Initializable, PubSub<GossipsubEvents> {
    /**
    ...
    readonly peers: Map<string, PeerStreams>;
    /** Direct peers */
     ...
     */
    init(components: Components): Promise<void>;
    /**
