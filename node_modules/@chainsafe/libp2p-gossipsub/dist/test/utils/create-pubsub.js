...
import { mockRegistrar, mockConnectionManager, mockConnectionGater, mockNetwork } from '@libp2p/interface-compliance-tests/mocks';
...
export const connectPubsubNodes = async (componentsA, componentsB) => {
    const multicodecs = new Set([...componentsA.getPubSub().multicodecs, ...componentsB.getPubSub().multicodecs]);
