...
export class Noise {
     ...
     */
    constructor(staticNoiseKey, earlyData, crypto = stablelib) {
        this.protocol = '/noise';
    ...
    async performHandshake(params) {
        ...
        if (tryIK) {
            ...
            const ikHandshake = new IKHandshake(isInitiator, payload, this.prologue, this.crypto, this.staticKeys, connection, 
            // safe to cast as we did checks
            KeyCache.load(params.remotePeer) ?? new Uint8Array(32), remotePeer);
            try {
                ...
                return await this.performXXFallbackHandshake(params, payload, err.initialMsg, ephemeralKeys);
            }
        }
        else {
            // run XX handshake
    ...
    async performXXFallbackHandshake(params, payload, initialMsg, ephemeralKeys) {
        ...
        const handshake = new XXFallbackHandshake(isInitiator, payload, this.prologue, this.crypto, this.staticKeys, connection, initialMsg, remotePeer, ephemeralKeys);
        try {
