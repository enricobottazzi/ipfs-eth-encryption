...
export declare function pushable(options?: BytePushableOptions): Pushable<Uint8Array>;
export declare function pushable<T>(options: ObjectPushableOptions): Pushable<T>;
export declare function pushableV(options?: BytePushableOptions): PushableV<Uint8Array>;
