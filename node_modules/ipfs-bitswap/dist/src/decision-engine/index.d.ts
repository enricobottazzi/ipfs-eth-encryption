export class DecisionEngine {
     ...
     */
    constructor(peerId: PeerId, blockstore: import('interface-blockstore').Blockstore, network: import('../network').Network, stats: import('../stats').Stats, libp2p: import('libp2p').Libp2p, opts?: {
