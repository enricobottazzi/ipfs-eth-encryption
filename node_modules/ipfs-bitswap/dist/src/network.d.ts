export class Network {
     ...
     */
    constructor(libp2p: import('libp2p').Libp2p, bitswap: import('./bitswap').Bitswap, stats: import('./stats').Stats, options?: {
...
export type Duplex = import('it-stream-types').Duplex<Uint8Array>;
