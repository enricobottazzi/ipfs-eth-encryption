...
export function createImport({ repo }: {
    repo: IPFSRepo;
}): (sources: AsyncIterable<Uint8Array> | Iterable<Uint8Array> | AsyncIterable<AsyncIterable<Uint8Array>> | Iterable<AsyncIterable<Uint8Array>>, options?: import("ipfs-core-types/src/dag/").ImportOptions | undefined) => AsyncIterable<import("ipfs-core-types/src/dag/").ImportResult>;
