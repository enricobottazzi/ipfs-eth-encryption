 ...
 */
export function createCp(context: MfsContext): (from: import("ipfs-core-types/dist/src/utils").IPFSPath | import("ipfs-core-types/dist/src/utils").IPFSPath[], to: string, opts?: import("ipfs-core-types/src/files").CpOptions | undefined) => Promise<void>;
