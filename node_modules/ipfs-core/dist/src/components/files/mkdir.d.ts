 ...
 */
export function createMkdir(context: MfsContext): (path: string, options?: import("ipfs-core-types/src/files").MkdirOptions | undefined) => Promise<void>;
...
export type DefaultOptions = {
    ...
    mtime?: import("ipfs-unixfs/types/src/types.js").MtimeLike | undefined;
