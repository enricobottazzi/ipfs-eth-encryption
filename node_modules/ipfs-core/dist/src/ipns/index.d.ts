...
export class IPNS {
     ...
     */
    constructor(routing: import('ipfs-core-types/src/utils').BufferStore, datastore: import('interface-datastore').Datastore, peerId: PeerId, keychain: import('@libp2p/interfaces/keychain').KeyChain, options: {
        pass: string;
...
export type PrivateKey = import('@libp2p/interfaces/keys').PrivateKey;
