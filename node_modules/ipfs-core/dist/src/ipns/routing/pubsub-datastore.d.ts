export class IpnsPubsubDatastore {
     ...
     */
    constructor(pubsub: import('@libp2p/interfaces/pubsub').PubSub, localDatastore: import('interface-datastore').Datastore, peerId: import('@libp2p/interfaces/peer-id').PeerId);
